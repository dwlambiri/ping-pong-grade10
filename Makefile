...
OBJS =		d-allegro.o ping-pong-main.o config-manager.o
...
$(OBJS) : d-allegro.cpp ping-pong-main.cpp config-manager.cpp
	$(CC) -c $(CFLAGS) -o d-allegro.o d-allegro.cpp
	$(CC) -c $(CFLAGS) -o ping-pong-main.o ping-pong-main.cpp
	$(CC) -c $(CFLAGS) -o config-manager.o config-manager.cpp
